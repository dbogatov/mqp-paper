\chapter{Evaluation Via User Studies}
	...
	\section{User Testing Procedure}
		...
		\subsection{User Tasks} 
			...
			The user tasks were given to the users in the order as indicated below. They were printed on a 
			sheet of paper so that the users could reference the task details at any time:
			
			\textbf{User Study Tasks: Part 1, Metric Builder feature}
			\textit{
			...
			\textbf{User Study Tasks: Part 2, API feature and documentation}
			...
			the user study can be found in Appendix \ref{app:userstudydocs}.
	...
	\section{Results}
		...
		For the API Documentation, many users commented on their difficulty in finding 
		...
		links found at the bottom of many webpages. The resulting change in location of the API Documentation link can be seen in Section 4.3.
			...
			\begin{figure}[t]
				\centering
				\fbox{\includegraphics[width=1.0\textwidth]{images/howto.png}}
	...
	\section{Changes Made}
		...
		Data Explorer page to mention that the link would also allow users to edit their metric. 
			...
			\begin{figure}[t]
				\centering
					\fbox{\includegraphics[width=1.0\textwidth]{images/footer.png}}
					\caption{Footer}
					\label{fig:footer}
			\end{figure}
			...
			\begin{figure}[t]
				\centering
					\fbox{\includegraphics[width=0.75\textwidth]{images/edit.png}}
		...
		Figure \ref{fig:docs} shows the API Documentation page as it appears when a user first navigates to the page from either the footer or the "How To Use MATTERS" page.
			...
			\begin{figure}[t]
				\centering
					\fbox{\includegraphics[width=1.0\textwidth]{images/mb.png}}
			...
			\begin{figure}[t]
				\centering
					\fbox{\includegraphics[width=1.0\textwidth]{images/using.png}}
			...
			\begin{figure}[t]
				\centering
					\fbox{\includegraphics[width=1.0\textwidth]{images/saved.png}}
					\caption{Save Menu}
					\label{fig:save}
			\end{figure}
			...
			\begin{figure}[t]
				\centering
					\fbox{\includegraphics[width=1.0\textwidth]{images/api.png}}
