\chapter{Testing}
	...
	\section{Results}
		...
		links found at the bottom of many webpages.
			...
			\begin{figure}[t]
				\centering
				\fbox{\includegraphics[width=0.5\textwidth]{images/howto.png}}
	...
	\section{Changes made}
		...
		Data Explorer page to mention that the link would also allow users to edit their metric. 
			...
			\begin{figure}[t]
				\centering
					\fbox{\includegraphics[width=0.5\textwidth]{images/footer.png}}
					\caption{Footer}
			\end{figure}
		...
		and API Documentation which can be seen in figures 5 through 8 below:
			...
			\begin{figure}[t]
				\centering
					\fbox{\includegraphics[width=0.5\textwidth]{images/mb.png}}
					\caption{Metric Builder}
			\end{figure}
			
			\begin{figure}[t]
				\centering
					\fbox{\includegraphics[width=0.5\textwidth]{images/using.png}}
					\caption{Metric Builder's canvas}
			\end{figure}
			
			\begin{figure}[t]
				\centering
					\fbox{\includegraphics[width=0.5\textwidth]{images/saved.png}}
					\caption{"Save" menu}
			\end{figure}
			
			\begin{figure}[t]
				\centering
					\fbox{\includegraphics[width=0.5\textwidth]{images/api.png}}
